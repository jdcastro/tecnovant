...
api.add_url_rule('/lots/<int:lot_id>/crops', view_func=lot_crop_view, methods=['GET', 'POST', 'DELETE'])
api.add_url_rule('/lots/<int:lot_id>/crops/<int:crop_id>', view_func=lot_crop_view, methods=['GET', 'PUT', 'DELETE'])
